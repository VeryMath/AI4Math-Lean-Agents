...
可选 Numina 路径请读取 `skills/lean-runtime/references/numina_runtime.md`。setup 和 official runner calls 可能 clone repositories、安装工具或使用外部 model/API credentials，因此执行前应先说明。
