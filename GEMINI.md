...
The helper CLI under `skills/lean-runtime/scripts/` is optional tooling shared by the two public Skill entrypoints. It can report and configure the built-in Numina adapter runtime, but the agent should still validate final Lean patches locally.
